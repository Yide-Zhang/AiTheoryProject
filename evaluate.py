...
from agents import BasicAgent, BasicAgentPro, FastHybridAgentV1, FastHybridAgentV2, IntegratedAgent
...
agent_a, agent_b = BasicAgentPro(), FastHybridAgentV2() # 与 BasicAgentPro 对打
